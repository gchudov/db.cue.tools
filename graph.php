...
$interval = 20;
$result = pg_query_params($dbconn, "SELECT EXTRACT(EPOCH FROM time) from submissions WHERE subid % $1 = 0 ORDER by time", array($interval))
...
$graph->title->Set('Database growth');
