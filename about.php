...
<h2>What information does the database contain per each CD?</h2>
<ul>
...
<li>Submission log, including user's ip addresses and CD drive model, which is used to eliminate erroneous submissions, virtual/faulty drives, and to verify if a submission by one user is independently confirmed.
</ul>
<h2>What about the license?</h2>
<ul>
<li>The sample client library is open source, LGPL, and available from CUETools page at sourceforge.
<li>The server code is open source, LGPL, and available <a href="http://hg.cuetools.net">here</a>.
<li>The database contents is public domain, except for the submission logs, which are not publicly available to protect the privacy of people contributing to the database.
</ul>
</body>
</html>
